      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div className="relative">
            ...
            <div className="flex gap-2 mt-4 justify-center">{challengeImages.map((img, i) => <button key={i} onClick={() => setCurrentImageIndex(i)} className={"w-16 h-16 rounded-lg overflow-hidden border-2 " + (currentImageIndex === i ? "border-primary" : "border-transparent opacity-60")}><img src={img} alt="" className="w-full h-full object-cover" loading="lazy" /></button>)}</div>
          </div>
